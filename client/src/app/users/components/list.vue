  ...
  <div class="column is-8">
    ...
    <nav v-if="getUser.isAdmin" class="level">
      ...
      <div class="level-right">
        <div class="level-item">
          <button type="button" v-bind:class="{ 'is-disabled' : this.checkedIds.length <= 0 }" class="button is-danger" @click="remove">Remove</button>
        </div>
        <div class="level-item">
          <button type="button" v-bind:class="{ 'is-disabled' : this.checkedIds.length !== 1 }" class="button is-info" @click="edit">Edit</button>
        </div>
        <div class="level-item">
          <button class="button is-primary" @click="navigate('newuser.form')">New User</button>
        </div>
      </div>
    </nav>
  </div>
